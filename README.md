...
*   **100% Private and Local**: Zero telemetry, zero cloud sync. All app configurations and monitored data remain strictly on your device. FocusFlow does not transmit any personal data or usage metrics.
*   **Multi-language Support**: Fully localized into English, Czech, Spanish, German, and Portuguese, easily selectable via an adaptive picker directly in the app.
*   **In-App Application Search**: Quickly find and filter your installed system and user applications to add them to your focus list, complete with official application logos.
*   **Modern Material 3 Interface**: Built completely using Jetpack Compose, featuring a beautiful, accessible, and high-contrast dark aesthetic designed for developers and power users.
...
*   **Accessibility Service Permission**: Required to instantly detect when a protected foreground application is launched.
*   **Do Not Disturb Access**: Required to automatically toggle notification filters without user intervention.
...
<p align="center">
  <sub>FocusFlow • Made by antunlar</sub>
</p>
